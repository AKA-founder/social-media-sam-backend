...
from api.views.views_message import handle_feedback
from api.views.pmp_webhooks import pmp_webhook
from api.views.ai import ai_ping
from api.views.health import status
from api.views import views_message, views_auth, views_ingest, views_chat
from api.chatbot_info import get_chatbot_info
from api.pdf_handler import upload_pdf_api
...
urlpatterns = [
    ...
    # PMPro webhook (bemærk trailing slash)
